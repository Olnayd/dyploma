...
public:
    ...
    void createLection( const qint32 clientdatabaseid, const CourseInformation& courseInfo, const CResponseContext& responseContext, ICourseResponseHandle& reponseHandle);
